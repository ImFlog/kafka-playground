package com.ippon.kafka.producer;
...
public class BasicProducer implements Runnable {
    ...
    public BasicProducer(String inputFile) {
    ...
    public void run() {
        ...
        BufferedReader bufferedReader = new BufferedReader(
                new InputStreamReader(getClass().getResourceAsStream("/" + inputFile)));
                ...
                .forEach(effectif -> {
                    try {
                        ...
                        kafkaProducer.send(
                                new ProducerRecord<>(
                                        "effectifs",
                                        String.valueOf(effectif.getYear()), // Shard by year
